...
export default function Sidebar() {
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <span className="d-none d-lg-block"><img className="img-fluid img-profile rounded-circle mx-auto mb-2" src={headshot.src} alt="A headshot photograph of Joe" /></span>
            </a>
